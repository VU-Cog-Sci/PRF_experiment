...
standard_parameters = {
    ...
    'n_targets':                                          80,             # number of target positions, right now ony 3/5/8 is possible (otherwise ITIs are messed with)
    ...
    ##############################
    'cue_dur':                                           .150,       # in s duration of fixation dim
    'target_delay':                                    .100,        # in s this is the saccade delay duration
    'response_window':                            2,       # in s this is the saccade delay duration
    'mean_iti':                                           1.5,            # should be an even integer
    'min_iti':                                              1,            # should be an even integer
